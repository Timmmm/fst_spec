...
| [[header_real_endianness,`header_real_endianness`]]`header_real_endianness`       | 25     | `f64`     | The value _e_ (2.7182818284590452354). This is used as an endianness test for reals. See <<Endianness>>.
...
1. The file format needs a magic number to help identify it, and ideally a major version number. These can be combined, e.g. the file can start with `FST2`, `FST3`, etc.
